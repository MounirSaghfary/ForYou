...
import AddFeedbackScreen from './AddFeedback';

const DeleteFeedbackloading = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: '#1c1c1e' }]}>
      ...
      <Text style={[styles.title, { color: '#fff' }]}>Feedback Deleted!</Text>
    </View>
  );
};
...
export default DeleteFeedbackloading;
